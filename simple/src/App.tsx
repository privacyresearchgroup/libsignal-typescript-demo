...
import { Paper, Grid, Avatar, Typography, Button, Chip, TextField, createTheme, ThemeProvider } from '@mui/material'
...
const initialStory = '# Start using the demo to see what is happening in the code'
                                ...
                                <Grid container>
                                    ...
                                    <Grid item xs={12}>
                                        {bHasIdentity ? (
                                            ...
                                            <Button variant="contained" onClick={createBrunhildeIdentity}>
